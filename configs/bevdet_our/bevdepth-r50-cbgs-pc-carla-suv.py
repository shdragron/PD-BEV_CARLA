# EVAL config for the PD-BEV CARLA SUV oracle (attempt-5, authors-native depth regime).
# MUST architecturally match the suv training config: input 384x704, depth grid [1,100,1]
...
data = dict(
    val=dict(ann_file='data/bevdet_infos/suv_infos_val.pkl', pipeline=test_pipeline),
    test=dict(ann_file='data/bevdet_infos/suv_infos_val.pkl', pipeline=test_pipeline))
