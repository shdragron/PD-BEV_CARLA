...
@BACKBONES.register_module()
def coc_tiny_1(pretrained=False, **kwargs):
    layers = [3, 4, 5, 2]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [8, 8, 4, 4]
...
@BACKBONES.register_module()
def coc_tiny_2(pretrained=False, **kwargs):
    layers = [3, 4, 5, 2]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [8, 8, 4, 4]
...
def coc_tiny_3(pretrained=False, **kwargs):
    layers = [3, 4, 4, 2]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [8, 8, 4, 4]
...
@BACKBONES.register_module(force=True)
def coc_tiny_4(pretrained=False, **kwargs):
    layers = [2, 4, 5, 2]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [8, 8, 4, 4]
...
@BACKBONES.register_module(force=True)
def coc_tiny_5(pretrained=False, **kwargs):
    layers = [2, 3, 6, 4]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [8, 8, 4, 4]
...
@BACKBONES.register_module(force=True)
def coc_tiny_6(pretrained=False, **kwargs):
    layers = [2, 3, 6, 4]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [8, 8, 4, 4]
...
@BACKBONES.register_module(force=True)
def coc_tiny_7(pretrained=False, **kwargs):
    layers = [2, 3, 6, 4]
    norm_layer = GroupNorm
    embed_dims = [32, 64, 196, 320]
    mlp_ratios = [4, 4, 2, 2]
